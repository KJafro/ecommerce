...
export default function About() {
  ...
  return (
    <>
    <Header/>
    <div className='aboutContainer' style={{display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", backgroundColor: "#eeeeee"}}>
    <img src="https://res.cloudinary.com/dyvsjxtxa/image/upload/v1686656478/api/employee1_rjsx6n.png" style={{marginTop: "10px", marginBottom: "10px", objectFit: "cover"}} alt="" />
    ...
    <img src="https://res.cloudinary.com/dyvsjxtxa/image/upload/v1686657112/api/employee3_vmeihj.png" style={{marginTop: "10px", marginBottom: "10px", objectFit: "cover"}} alt="" />
    ...
    <img src="https://res.cloudinary.com/dyvsjxtxa/image/upload/v1686657681/api/employeees_jhkvo2.png" style={{marginTop: "10px", marginBottom: "10px", objectFit: "cover"}} alt="" />
